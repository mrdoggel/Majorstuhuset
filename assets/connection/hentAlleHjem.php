<div class="addknapper"><button id="addHjem" class="add adminKnapp"><div class="inside"></div></button></div>
<?php 
require "conn.php";
...
if ($result->num_rows > 0) {
    ...
    echo '      </p>
                <div class="knapper">
                <button class="oppdaterHjem adminKnapp" name="';
                    echo $id; 
    echo '"><div class="inside"></div></button>
                ...
                <input type="hidden" name="id" value="';
                    echo $id;
                    echo '">
                <button class="slettHjem adminKnapp" name="'; 
                    echo $id; 
