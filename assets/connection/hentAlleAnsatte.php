<div class="addknapper"><button id="addAnsatte" class="add"><div class="inside"></div></button></div>
<?php 
require "conn.php";
...
if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
        ...
        echo $id;
        echo '">
                    <div style="text-align:center;" class="bilde" onmouseover="bildeMouseover()" onmouseout="bildeMouseoverRemove()";>
                        ...
                        if ($bilde != "assets/web/gfx/1.5/user.png") {
                            ...
                            echo $id;
                            echo '">
                            <button class="slettAnsatteBilde" name="'; 
                            echo $id; 
        ...
        echo '          </p>
                    ...
                    <div class="knapper">
                <button class="oppdaterAnsatte" name="';
                    echo $id; 
        echo '"><div class="inside"></div></button>
                ...
                <input type="hidden" name="id" value="';
                    echo $id;
                    echo '">
                <button class="slettAnsatte" name="'; 
                    echo $id; 
        echo '"><div class="inside"></div></button></form>
            </div>
                </div>';
