<div class="addknapper"><button id="addBestilling" class="add"><div class="inside"></div></button></div>
<?php 
require "conn.php";
...
if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
        ...
        echo '      </p>
        <div class="knapper">
                <button class="oppdaterBestilling" name="';
                    echo $id; 
        echo '"><div class="inside"></div></button>
                ...
                <input type="hidden" name="id" value="';
                    echo $id;
                    echo '">
                <button class="slettBestilling" name="'; 
                    echo $id; 
